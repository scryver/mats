...
opts="-O3 -std=c++17 -g -ggdb -msse4 -Wall -Werror -Wno-gnu-zero-variadic-macro-arguments -Wno-gnu-anonymous-struct -Wno-nested-anon-types -Wno-missing-braces -Wno-unused-function -Wno-writable-strings -Wno-c99-extensions"
