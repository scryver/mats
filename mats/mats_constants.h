...
global const f32 gLn2HighF32s[2]   = {6.9313812256e-01f, -6.9313812256e-01f}; /* 0x3f317180, 0xbf317180 */
global const f32 gLn2LowF32s[2]    = {9.0580006145e-06f, -9.0580006145e-06f}; /* 0x3717f7d1, 0xb717f7d1 */
