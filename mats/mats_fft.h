...
func void fft_shift32(u32 count, c32 *data);
func void fft_shift64(u32 count, c64 *data);

func void magnitude_from_fft32(u32 count, c32 *source, f32 *dest);
func void magnitude_from_fft64(u32 count, c64 *source, f64 *dest);
func void db_from_fft32(u32 count, c32 *source, f32 *dest);
func void db_from_fft64(u32 count, c64 *source, f64 *dest);
func void phase_from_fft32(u32 count, c32 *source, f32 *dest);
func void phase_from_fft64(u32 count, c64 *source, f64 *dest);
func void unwrapped_phase_from_fft32(u32 count, c32 *source, f32 *dest);
func void unwrapped_phase_from_fft64(u32 count, c64 *source, f64 *dest);
...
func void fft_inplace(u32 count, c32 *data);
func void fft_inplace_fast(u32 count, c32 *data);

func void fft_build_table_f32(u32 count, f32 *dest);
func void fft_inplace_table(u32 count, c32 *dest, f32 *sinCosTable);
...
func void ifft_inplace(u32 count, c32 *data);
func void ifft_inplace_fast(u32 count, c32 *data);

func void ifft_build_table_f32(u32 count, f32 *dest);
func void ifft_inplace_table(u32 count, c32 *dest, f32 *sinCosTable);
...
func void fft_inplace64(u32 count, c64 *data);
func void fft_inplace_fast64(u32 count, c64 *data);

func void fft_build_table_f64(u32 count, f64 *dest);
func void fft_inplace_table64(u32 count, c64 *dest, f64 *sinCosTable);
...
func void ifft_inplace64(u32 count, c64 *data);
func void ifft_inplace_fast64(u32 count, c64 *data);

func void ifft_build_table_f64(u32 count, f64 *dest);
func void ifft_inplace_table64(u32 count, c64 *dest, f64 *sinCosTable);
