...
{
    SinCos32_4x csBase = sincos32_4x(F32_4x(0.0f, -0.25f * F32_PI, -0.5f * F32_PI, -0.75f * F32_PI));
    _mm_store_ps(dest + 0, csBase.sin.m);
    _mm_store_ps(dest + 4, csBase.cos.m);
    ...
    while (m <= count)
    {
        ...
        {
            SinCos32_4x cs0 = sincos32_4x(angles);
            _mm_store_ps(dest + idx + 0, cs0.sin.m);
            _mm_store_ps(dest + idx + 4, cs0.cos.m);
            angles = angles + angleStep;

            SinCos32_4x cs1 = sincos32_4x(angles);
            _mm_store_ps(dest + idx +  8, cs1.sin.m);
            _mm_store_ps(dest + idx + 12, cs1.cos.m);
            angles = angles + angleStep;
...
fft_inplace_table(u32 count, c32 *dest, f32 *sinCosTable)
{
    ...
    // NOTE(michiel): w = e^(-i*2pi*j/m)
    f32 *sinCosTableSrc = sinCosTable;
    f32_4x sinBase = F32_4x(sinCosTableSrc);
    sinCosTableSrc += 4;
    f32_4x cosBase = F32_4x(sinCosTableSrc);
    sinCosTableSrc += 4;

    f32_4x cos42; cos42.m = _mm_shuffle_ps(cosBase.m, cosBase.m, MULTILANE_SHUFFLE_MASK(2, 2, 2, 2));
    f32_4x sin42; sin42.m = _mm_shuffle_ps(sinBase.m, sinBase.m, MULTILANE_SHUFFLE_MASK(2, 2, 2, 2));
    f32_4x cos801; cos801.m = _mm_shuffle_ps(cosBase.m, cosBase.m, MULTILANE_SHUFFLE_MASK(0, 0, 1, 1));
    f32_4x sin801; sin801.m = _mm_shuffle_ps(sinBase.m, sinBase.m, MULTILANE_SHUFFLE_MASK(0, 0, 1, 1));
    f32_4x cos823; cos823.m = _mm_shuffle_ps(cosBase.m, cosBase.m, MULTILANE_SHUFFLE_MASK(2, 2, 3, 3));
    f32_4x sin823; sin823.m = _mm_shuffle_ps(sinBase.m, sinBase.m, MULTILANE_SHUFFLE_MASK(2, 2, 3, 3));
    ...
    while (m <= count)
    {
        for (u32 k = 0; k < count; k += m)
        {
            ...
            for (u32 j = 0; j < halfM; j += 8)
            {
                ...
                f32_4x sin0 = F32_4x(scTable);
                scTable += 4;
                f32_4x cos0 = F32_4x(scTable);
                scTable += 4;

                f32_4x O03r = cos0 * src103r - sin0 * src103i;
                f32_4x O03i = cos0 * src103i + sin0 * src103r;
                ...
                f32_4x sin1 = F32_4x(scTable);
                scTable += 4;
                f32_4x cos1 = F32_4x(scTable);
                scTable += 4;

                f32_4x O47r = cos1 * src147r - sin1 * src147i;
                f32_4x O47i = cos1 * src147i + sin1 * src147r;
...
fft_inplace64(u32 count, c64 *dest)
{
    ...
    f64_2x cos42 = F64_2x(csBase2.cos);
    f64_2x sin42 = F64_2x(csBase2.sin);
    f64_2x cos80 = F64_2x(csBase0.cos);
    f64_2x cos81 = F64_2x(csBase1.cos);
    f64_2x cos82 = F64_2x(csBase2.cos);
    f64_2x cos83 = F64_2x(csBase3.cos);
    f64_2x sin80 = F64_2x(csBase0.sin);
    f64_2x sin81 = F64_2x(csBase1.sin);
    f64_2x sin82 = F64_2x(csBase2.sin);
    f64_2x sin83 = F64_2x(csBase3.sin);
...
fft_inplace_table64(u32 count, c64 *dest, f64 *sinCosTable)
{
    ...
    // NOTE(michiel): w = e^(-i*2pi*j/m)
    f64 *sinCosTableSrc = sinCosTable;
    f64_2x sin80; sin80.md = _mm_load_pd1(sinCosTableSrc++);
    f64_2x cos80; cos80.md = _mm_load_pd1(sinCosTableSrc++);
    f64_2x sin81; sin81.md = _mm_load_pd1(sinCosTableSrc++);
    f64_2x cos81; cos81.md = _mm_load_pd1(sinCosTableSrc++);
    f64_2x sin82; sin82.md = _mm_load_pd1(sinCosTableSrc++);
    f64_2x cos82; cos82.md = _mm_load_pd1(sinCosTableSrc++);
    f64_2x sin83; sin83.md = _mm_load_pd1(sinCosTableSrc++);
    f64_2x cos83; cos83.md = _mm_load_pd1(sinCosTableSrc++);
    f64_2x sin42 = sin82;
    f64_2x cos42 = cos82;
    ...
    while (m <= count)
    {
        for (u32 k = 0; k < count; k += m)
        {
            ...
            f64 *scTable = sinCosTableSrc;

            for (u32 j = 0; j < halfM; j += 8)
            {
                f64_2x sin0; sin0.md = _mm_load_pd1(scTable++);
                f64_2x cos0; cos0.md = _mm_load_pd1(scTable++);
                f64_2x oSrc0ri = F64_2x(OGrab);
                OGrab += 2;

                f64_2x oSrc0ir; oSrc0ir.md = _mm_shuffle_pd(oSrc0ri.md, oSrc0ri.md, MULTILANE_SHUFFLE_MASK_D(1, 0));
                f64_2x ocs0ri = cos0 * oSrc0ri;
                f64_2x osc0ir = sin0 * oSrc0ir;
                f64_2x o0ri; o0ri.md = _mm_addsub_pd(ocs0ri.md, osc0ir.md);

                f64_2x sin1; sin1.md = _mm_load_pd1(scTable++);
                f64_2x cos1; cos1.md = _mm_load_pd1(scTable++);
                f64_2x oSrc1ri = F64_2x(OGrab);
                OGrab += 2;

                f64_2x oSrc1ir; oSrc1ir.md = _mm_shuffle_pd(oSrc1ri.md, oSrc1ri.md, MULTILANE_SHUFFLE_MASK_D(1, 0));
                f64_2x ocs1ri = cos1 * oSrc1ri;
                f64_2x osc1ir = sin1 * oSrc1ir;
                f64_2x o1ri; o1ri.md = _mm_addsub_pd(ocs1ri.md, osc1ir.md);

                f64_2x sin2; sin2.md = _mm_load_pd1(scTable++);
                f64_2x cos2; cos2.md = _mm_load_pd1(scTable++);
                f64_2x oSrc2ri = F64_2x(OGrab);
                OGrab += 2;

                f64_2x oSrc2ir; oSrc2ir.md = _mm_shuffle_pd(oSrc2ri.md, oSrc2ri.md, MULTILANE_SHUFFLE_MASK_D(1, 0));
                f64_2x ocs2ri = cos2 * oSrc2ri;
                f64_2x osc2ir = sin2 * oSrc2ir;
                f64_2x o2ri; o2ri.md = _mm_addsub_pd(ocs2ri.md, osc2ir.md);

                f64_2x sin3; sin3.md = _mm_load_pd1(scTable++);
                f64_2x cos3; cos3.md = _mm_load_pd1(scTable++);
                f64_2x oSrc3ri = F64_2x(OGrab);
                OGrab += 2;

                f64_2x oSrc3ir; oSrc3ir.md = _mm_shuffle_pd(oSrc3ri.md, oSrc3ri.md, MULTILANE_SHUFFLE_MASK_D(1, 0));
                f64_2x ocs3ri = cos3 * oSrc3ri;
                f64_2x osc3ir = sin3 * oSrc3ir;
                f64_2x o3ri; o3ri.md = _mm_addsub_pd(ocs3ri.md, osc3ir.md);

                f64_2x sin4; sin4.md = _mm_load_pd1(scTable++);
                f64_2x cos4; cos4.md = _mm_load_pd1(scTable++);
                f64_2x oSrc4ri = F64_2x(OGrab);
                OGrab += 2;

                f64_2x oSrc4ir; oSrc4ir.md = _mm_shuffle_pd(oSrc4ri.md, oSrc4ri.md, MULTILANE_SHUFFLE_MASK_D(1, 0));
                f64_2x ocs4ri = cos4 * oSrc4ri;
                f64_2x osc4ir = sin4 * oSrc4ir;
                f64_2x o4ri; o4ri.md = _mm_addsub_pd(ocs4ri.md, osc4ir.md);

                f64_2x sin5; sin5.md = _mm_load_pd1(scTable++);
                f64_2x cos5; cos5.md = _mm_load_pd1(scTable++);
                f64_2x oSrc5ri = F64_2x(OGrab);
                OGrab += 2;

                f64_2x oSrc5ir; oSrc5ir.md = _mm_shuffle_pd(oSrc5ri.md, oSrc5ri.md, MULTILANE_SHUFFLE_MASK_D(1, 0));
                f64_2x ocs5ri = cos5 * oSrc5ri;
                f64_2x osc5ir = sin5 * oSrc5ir;
                f64_2x o5ri; o5ri.md = _mm_addsub_pd(ocs5ri.md, osc5ir.md);

                f64_2x sin6; sin6.md = _mm_load_pd1(scTable++);
                f64_2x cos6; cos6.md = _mm_load_pd1(scTable++);
                f64_2x oSrc6ri = F64_2x(OGrab);
                OGrab += 2;

                f64_2x oSrc6ir; oSrc6ir.md = _mm_shuffle_pd(oSrc6ri.md, oSrc6ri.md, MULTILANE_SHUFFLE_MASK_D(1, 0));
                f64_2x ocs6ri = cos6 * oSrc6ri;
                f64_2x osc6ir = sin6 * oSrc6ir;
                f64_2x o6ri; o6ri.md = _mm_addsub_pd(ocs6ri.md, osc6ir.md);

                f64_2x sin7; sin7.md = _mm_load_pd1(scTable++);
                f64_2x cos7; cos7.md = _mm_load_pd1(scTable++);
                f64_2x oSrc7ri = F64_2x(OGrab);
                OGrab += 2;

                f64_2x oSrc7ir; oSrc7ir.md = _mm_shuffle_pd(oSrc7ri.md, oSrc7ri.md, MULTILANE_SHUFFLE_MASK_D(1, 0));
                f64_2x ocs7ri = cos7 * oSrc7ri;
                f64_2x osc7ir = sin7 * oSrc7ir;
                f64_2x o7ri; o7ri.md = _mm_addsub_pd(ocs7ri.md, osc7ir.md);
